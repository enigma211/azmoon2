    ...
    <div class="mb-8 text-center">
        ...
        @else
            ...
            <div class="mt-6 p-6 bg-red-50 border border-red-200 rounded-xl text-center">
                ...
                <a href="{{ route('pricing') }}" wire:navigate class="inline-flex items-center gap-2 bg-red-600 text-white font-bold py-3 px-6 rounded-xl hover:bg-red-700 transition">
