...
✅ محدودیت 15 دقیقه‌ای بین تیکت‌ها  
...
✅ **Rate Limiting:** کاربر نمی‌تواند بیش از یک تیکت در 15 دقیقه ارسال کند  
...
1. ✅ ایجاد تیکت جدید
2. ✅ محدودیت 15 دقیقه
3. ✅ مشاهده لیست تیکت‌ها
4. ✅ مشاهده جزئیات تیکت
5. ✅ پاسخ ادمین در پنل
6. ✅ مشاهده پاسخ توسط کاربر
7. ✅ تغییر وضعیت تیکت
