...
✅ فیلتر بر اساس وضعیت  
✅ دکمه "پاسخ" برای پاسخگویی به تیکت‌ها  
✅ تغییر خودکار وضعیت به "پاسخ داده شده" پس از ارسال پاسخ  
✅ نمایش تعداد تیکت‌های پاسخ داده نشده با badge قرمز در sidebar  
...
2. از منوی سمت راست، "تیکت پشتیبانی" را انتخاب کنید
   - اگر تیکت پاسخ داده نشده وجود داشته باشد، یک badge قرمز با تعداد نمایش داده می‌شود
3. لیست تیکت‌ها را مشاهده کنید
4. روی دکمه "پاسخ" (سبز رنگ) کلیک کنید
5. پاسخ خود را در قسمت "پاسخ ادمین" بنویسید
6. ذخیره کنید - وضعیت به صورت خودکار به "پاسخ داده شده" تغییر می‌کند
